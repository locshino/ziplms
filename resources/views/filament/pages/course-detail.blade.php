                    ...
                    <div class="grid md:grid-cols-3 sm:grid-cols-2 gap-6">
                        @foreach ($this->completedQuizzes as $i => $quiz)
                            @php
                                ...
                                if ($quiz->status === \App\Enums\Status\QuizStatus::ARCHIVED->value) {
                            ...
                            <div
                                ...
                                <div class="p-5">
                                    ...
                                    @if ($statusLabel)
                                        <span
                                            class="inline-flex items-center text-xs font-medium text-gray-500 dark:text-gray-400 space-x-1">
