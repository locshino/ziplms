 ...
 * @property \Illuminate\Database\Eloquent\Collection<int, \App\Models\Tag> $tags
 * @property-read int|null $tags_count
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Location withAllTags(\ArrayAccess|\Spatie\Tags\Tag|array|string $tags, ?string $type = null)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Location withAllTagsOfAnyType($tags)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Location withAnyTags(\ArrayAccess|\Spatie\Tags\Tag|array|string $tags, ?string $type = null)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Location withAnyTagsOfAnyType($tags)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Location withAnyTagsOfType(array|string $type)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Location withoutTags(\ArrayAccess|\Spatie\Tags\Tag|array|string $tags, ?string $type = null)
 */
	class Location extends \Eloquent implements \Spatie\MediaLibrary\HasMedia {}
}
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia ordered()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia query()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereCollectionName($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereConversionsDisk($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereCustomProperties($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereDisk($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereFileName($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereGeneratedConversions($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereManipulations($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereMimeType($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereModelId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereModelType($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereOrderColumn($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereResponsiveImages($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereSize($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|SpatieMedia whereUuid($value)
 */
	class SpatieMedia extends \Eloquent {}
}
