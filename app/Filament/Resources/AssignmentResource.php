    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                //         return view('filament.assignments.course-with-assignments', [
                //             'assignments' => $assignments,
                //             'course' => $course,
                //         ]);
                //     }),
                // ->expandable(fn($record) => view('filament.assignments.inline-by-course', [
                //     'assignments' => $record->assignments, // relationship
