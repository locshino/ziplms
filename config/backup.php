...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'disks' => explode(',', env('BACKUP_DESTINATION_DISKS', 'local')),
        ],

        /*
         * The directory where the temporary files will be stored.
         */
        'temporary_directory' => storage_path('app/temporary/backup-temp'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL_TO', 'your@example.com'),
    ...
    'monitor_backups' => [
        [
            'name' => env('APP_NAME', 'laravel-backup'),
            'disks' => explode(',', env('BACKUP_MONITOR_DISKS', 'local')),
            'health_checks' => [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => (int) env('BACKUP_CLEANUP_KEEP_ALL_DAYS', 7),
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => (int) env('BACKUP_CLEANUP_DELETE_OLDEST_MB_LIMIT', 5000),
        ],
